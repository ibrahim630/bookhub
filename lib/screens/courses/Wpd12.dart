  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Web Development and Database",
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            Pdfdownload(
                imageName:
                    "https://pustakalaya.org/media/uploads/thumbnails/document/2020/08/06/Web_Development_and_Database__Grade_12.jpg",
                pdfName: "Web Development and Database",
                url:
