  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:
            Text("Computer Network", style: TextStyle(color: Colors.black87)),
        actions: [
          IconButton(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            Pdfdownload(
                imageName:
                    "https://pustakalaya.org/media/uploads/thumbnails/document/2020/08/26/Computer_Networks__Grade_10.jpg",
                pdfName: "Computer Network",
                url:
                    "https://pustakalaya.org/media/uploads/documents/2020/08/26/_a701199e/Grade_-_10_Computer_Engineering_-_Computer_Networks.pdf"),
            CardBox(
