  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Electornic Device and Circuit",
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            Pdfdownload(
                imageName:
                    "https://pustakalaya.org/media/uploads/thumbnails/document/2020/08/26/Electronic_Device_and_Circuit__Grade_10.jpg",
                pdfName: "Electornic Device and Circuit",
                url:
                    "https://pustakalaya.org/media/uploads/documents/2020/08/26/_b4b47685/Grade_-_10_Computer_Engineering_-_Electronic_Device_and_Circuit.pdf"),
            CardBox(
